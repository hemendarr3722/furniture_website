...
import { MapPin, Phone, Mail, Sofa } from 'lucide-react';
    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">
                Comfort <span className="text-amber-600">Living</span>
              </span>
            </div>
            <p className="text-sm leading-relaxed">
              Your trusted destination for premium quality furniture. We bring comfort and style to your home with our carefully curated collection.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+919876543210" className="text-sm hover:text-amber-600 transition-colors">
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-amber-600 flex-shrink-0" />
                <a href="mailto:info@comfortliving.com" className="text-sm hover:text-amber-600 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Comfort Living. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
